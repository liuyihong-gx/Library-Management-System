...
public class ReaderSearch extends JFrame {
	...
	public ReaderSearch() {
		...
		JLabel readerSearchLabel = new JLabel("\u8BFB\u8005\u57FA\u672C\u4FE1\u606F\u67E5\u8BE2");
		readerSearchLabel.setForeground(new Color(25, 25, 112));
		readerSearchLabel.setHorizontalAlignment(SwingConstants.CENTER);
		readerSearchLabel.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.BOLD, 76));
		readerSearchLabel.setBounds(90, 5, 620, 85);
		contentPane.add(readerSearchLabel);
		...
		searchButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (!DataProcessing.searchCardID(cardIDText.getText())) {
					...
					ReaderSearchResult page = new ReaderSearchResult(cardIDText.getText());
		...
		try {
			...
			System.out.println("ReaderSearch:±≥æ∞Õº∆¨‘ÿ»Î ß∞‹");
		}
